<template>
    ...
    <div class="flex flex-row justify-between">
        <div class="flex flex-row gap-4 items-center">
            ...
            <button v-for="n in 6" :key="n" class="bg-gray-200 px-4 py-2 text-sm text-gray-500 rounded-md focus:outline-none">
                {{ n }}
            </button>

            <span class="text-sm text-gray-500">Personen</span>
        </div>
